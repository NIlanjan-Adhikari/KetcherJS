...
export default {
	...
	cut: {
		...
		title: 'Cut',
		action: () => {
			exec('cut') || dontClipMessage('Cut (Ctrl/⌘ + x)'); // eslint-disable-line no-unused-expressions
		},
	...
	copy: {
		...
		title: 'Copy',
		action: () => {
			exec('copy') || dontClipMessage('Copy (Ctrl/⌘ + c)'); // eslint-disable-line no-unused-expressions
		},
		disabled: editor => !hasSelection(editor)
	},
	paste: {
		...
		title: 'Paste',
		action: () => {
			exec('paste') || dontClipMessage('Paste (Ctrl/⌘ + v)'); // eslint-disable-line no-unused-expressions
		},
		selected: ({ actions }) => (
			actions && // TMP
